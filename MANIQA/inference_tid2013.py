...
if __name__ == '__main__':
    ...
    config = Config({
        # dataset path
        "db_name": "TID2013",
        "test_dis_path": "../../datasets/tid2013/distorted_images",
        "test_mos_path": "../../datasets/tid2013/mos.txt",
        
        # optimization
        "batch_size": 8,
        "num_avg_val": 20, # number of crops to average to get a final score for an image
        "crop_size": 224,
        "is_rand_crop": True,
        ...
        "valid": "output/valid",
        "valid_path": "output/valid/inf_tid_table4_5seeds_pipal_randcrop20",
        "model_object": 
            [
                r"C:\Users\MQTyor\ai_pc\Reserch_ai\IQA\projects\MANIQA_experiments\output\models\model_maniqa__seed12512\epoch1",
                r"C:\Users\MQTyor\ai_pc\Reserch_ai\IQA\projects\MANIQA_experiments\output\models\model_maniqa__seed23541\epoch1",
                r"C:\Users\MQTyor\ai_pc\Reserch_ai\IQA\projects\MANIQA_experiments\output\models\model_maniqa__seed32672\epoch1",
                r"C:\Users\MQTyor\ai_pc\Reserch_ai\IQA\projects\MANIQA_experiments\output\models\model_maniqa__seed52882\epoch1",
                r"C:\Users\MQTyor\ai_pc\Reserch_ai\IQA\projects\MANIQA_experiments\output\models\model_maniqa__seed83532\epoch1",
    ...
    compute_metrics.main(config, 'AVG', avg_out_filename)
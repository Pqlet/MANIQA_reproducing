...
Modifications and additions for timm_ hacked together by / Copyright 2021, Ross Wightman
"""
...
class XCiT(nn.Module):
    """
    Based on timm_ and DeiT code bases
...
def checkpoint_filter_fn(state_dict, model):
    ...
    # For consistency with timm_'s transformer models while being compatible with official weights source we rename
    ...
    for k in pos_embed_keys:
        if use_pos_embed:
            ...
            del state_dict[k]
    # timm_'s implementation of class attention in CaiT is slightly more efficient as it does not compute query vectors

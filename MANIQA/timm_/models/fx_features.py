...
# NOTE: By default, any modules from timm_.models.layers that we want to treat as leaf modules go here
# BUT modules from timm_.models should use the registration mechanism below
_leaf_modules = {
...
def register_notrace_module(module: nn.Module):
    """
    Any module not under timm_.models.layers should get this decorator if we don't want to trace through it.
    """
